 ...
 * @author metar
 */
public class Outquerist1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        double a = Double.parseDouble(total); //String型をdouble型に変える
        double b = Double.parseDouble(count); //String型をdouble型に変える
